 ...
 * 
 * @example        <b>Syntax:</b>
 *                 JKIL.sortings.array.doInsertionSort ( pa_array[, ph_options] )
 * 
 * @example        <b>Example 1:</b>
 *                 var a = JKIL.sortings.array.doInsertionSort ( numberArray );
 * 
 * @example        <b>Example 2:</b>
 *                 var a = JKIL.sortings.array.doInsertionSort ( numberArray, {ascending: false} );
 * 
 * @example        <b>Example 3:</b>
 *                 var a = JKIL.sortings.array.doInsertionSort ( numberArray, {ascending: true, comparator: JKIL.comparators.compareNumbers} );
 * 
 ...
 * @throws         TODO
 * 
 * @see            Rohaut. S. (2007) <i>Algorithmique - Techniques fondamentales de programmation (avec des exemples en Java)</i>, Eni éditions. c. Le tri par sélection p. 112<br /><br />
 ...
 */
JKIL.sortings.array.doInsertionSort = function (pa_array, ph_options) {
