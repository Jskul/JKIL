 ...
 * 
 * @description	Compares two string using the <code>&lt;</code> and <code>&gt;</code> operators.
 * 
 * @example		<b>Syntax:</b>
 * 				JKIL.comparators.strings ( ps_a, ps_b )
 * 
 ...
 * 
 */
JKIL.comparators.strings = function (ps_a, ps_b) {
	/*
